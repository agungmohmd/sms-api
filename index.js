...
app.post('/sms', function (req, res) {
    ...
    if (req.body) {
        ...
        res.locals.connection.query(query, function (error, results, fields) {
            ...
            let ep = `http://www.myvaluefirst.com/smpp/sendsms?to=${req.body.to}&text=${req.body.message}&username=demoindo1&from=${req.body.from}&password=http1313&dlr-url=https://api.agungmohmd.xyz/receipt`
            axios.get(ep)
                .then(resx => {
